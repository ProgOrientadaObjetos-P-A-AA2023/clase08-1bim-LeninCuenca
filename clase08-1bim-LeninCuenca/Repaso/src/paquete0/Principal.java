...
public class Principal {
        ...
        while (bandera) {
            ...
            if (opcion == 1) {
                ...
                if (opcion == 2) {
                    ...
                    if (opcion==5) {
                           boolean jugador=verificarnomJugador();
                           if (jugador) {
    ...
    public static boolean verificarnomJugador(){
        int pt=0;
        Scanner entrada=new Scanner(System.in);
        boolean bandera = false;
       ...
       if (c==null) {
        ...
        if (c != null) {
            EscrituraSecuencialJugador archivo
                    = new EscrituraSecuencialJugador(nombreArchivoClub);
            Jugador ju = new Jugador(nomjugador,pt, c);
            // establecer el valor del atributo registro
            archivo.establecerRegistro(ju);
            // establecer en el archivo el atributo del registro
            archivo.establecerSalida();
            archivo.cerrarArchivo();
            bandera = true;
